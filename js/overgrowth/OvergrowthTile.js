...
OvergrowthTile.prototype.setAccentInfo = function() {
	if (this.code === 'R') {
...
OvergrowthTile.prototype.setSpecialFlowerInfo = function() {
	if (this.code === 'L') {
...
OvergrowthTile.prototype.getImageName = function() {
	return this.ownerCode + "" + this.code;
};

OvergrowthTile.prototype.formsHarmonyWith = function(otherTile) {
...
OvergrowthTile.prototype.clashesWith = function(otherTile) {
...
OvergrowthTile.prototype.getMoveDistance = function() {
...
OvergrowthTile.prototype.drain = function() {
	if (this.type === BASIC_FLOWER) {
		this.drained = true;
	}
};

OvergrowthTile.prototype.restore = function() {
	this.drained = false;
};

OvergrowthTile.prototype.getName = function() {
	return OvergrowthTile.getTileName(this.code);
};

OvergrowthTile.prototype.getCopy = function() {
	return new OvergrowthTile(this.code, this.ownerCode);
};


OvergrowthTile.getTileName = function(tileCode) {
	var name = "";
...
OvergrowthTile.getClashTileCode = function(tileCode) {
