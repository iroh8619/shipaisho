...
export function TrifleWhenTargetTileLandsSurroundingTriggerBrain(triggerContext) {
	this.targetTiles = [];
...
TrifleWhenTargetTileLandsSurroundingTriggerBrain.prototype.isTriggerMet = function() {
