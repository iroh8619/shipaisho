...
export function SolitaireActuator(gameContainer, isMobile) {
	...
	var containers = setupPaiShoBoard(
		this.gameContainer, 
		SolitaireController.getHostTilesContainerDivs(),
		SolitaireController.getGuestTilesContainerDivs(), 
		false
	);
...
SolitaireActuator.prototype.actuate = function(board, theGame, markingManager, drawnTile) {
	var self = this;
...
SolitaireActuator.prototype.htmlify = function(board, theGame, markingManager, drawnTile) {
