...
StreetController.prototype.getDefaultHelpMessageText = function() {
	return "<h4>Street Pai Sho</h4> <p>Street Pai Sho is meant to be a great game that is simple and easy to learn.</p><p>The goal is to form a Harmony across each <em>midline</em>, which are the lines from the center of the board to the edge of the board that divide each quadrant. Currently the game is being tweaked and tested by The Garden Gate Community. Please see the <a href='https://skudpaisho.com/site/games/street-pai-sho/' target='_blank'>rules page</a> for more rules and information. Please join The Garden Gate Discord and help improve this game!</p>";
};
...
StreetController.prototype.RmbDown = function(htmlPoint) {
...
StreetController.prototype.RmbUp = function(htmlPoint) {
	var npText = htmlPoint.getAttribute("name");
